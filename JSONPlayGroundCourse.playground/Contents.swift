...
struct Fruit: Codable { //ha de conformar el protocol "Codable" per processar els JSON
    ...
    //descodificació anidadada (s'ha de fer quan hi ha una estructura tipus la de location al JSON)
